...
const float hp_beta[] = {HP_GAIN, -3 * HP_GAIN, 3 * HP_GAIN,
                         -HP_GAIN}; // butter(3, 0.75, 'high')
...
class BlockMetricsCalculatorIIR : public BlockMetricsCalculator {
  ...
  void calculate_block_sharpness_values(ImageData &image, cv::Rect &blockRoi,
                                        BlockMetrics *block);
